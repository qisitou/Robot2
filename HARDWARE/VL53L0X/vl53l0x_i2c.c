...
void VL53L0X_i2c_init(void)
{
	...
	GPIO_InitStructure.GPIO_Pin = VL53L0X_SCL_PIN;//端口配置
	GPIO_InitStructure.GPIO_Mode = GPIO_Mode_OUT;//普通输出模式
	GPIO_InitStructure.GPIO_OType = GPIO_OType_OD;//开漏输出
	GPIO_InitStructure.GPIO_Speed = GPIO_Speed_100MHz;//100MHz
	GPIO_InitStructure.GPIO_PuPd = GPIO_PuPd_UP;//上拉
	GPIO_Init(VL_IIC_PORT, &GPIO_InitStructure);//初始化

	GPIO_InitStructure.GPIO_Pin = VL53L0X_SDA_PIN;//端口配置
...
//	GPIO_InitStructure.GPIO_Pin = VL53L0X_XshutPin_0;//端口配置
//	GPIO_InitStructure.GPIO_Mode = GPIO_Mode_OUT;//普通输出模式
//	GPIO_InitStructure.GPIO_OType = GPIO_OType_PP;//推挽输出
//	GPIO_InitStructure.GPIO_Speed = GPIO_Speed_100MHz;//100MHz
//	GPIO_InitStructure.GPIO_PuPd = GPIO_PuPd_UP;//上拉
//	GPIO_Init(VL53L0X_XshutPort_0, &GPIO_InitStructure);//初始化

//    GPIO_InitStructure.GPIO_Pin = VL53L0X_XshutPin_1;//端口配置
//    GPIO_InitStructure.GPIO_Mode = GPIO_Mode_OUT;//普通输出模式
//    GPIO_InitStructure.GPIO_OType = GPIO_OType_PP;//推挽输出
//    GPIO_InitStructure.GPIO_Speed = GPIO_Speed_100MHz;//100MHz
//    GPIO_InitStructure.GPIO_PuPd = GPIO_PuPd_UP;//上拉
//    GPIO_Init(VL53L0X_XshutPort_1, &GPIO_InitStructure);//初始化

    GPIO_InitStructure.GPIO_Pin = VL53L0X_XshutPin_2;//端口配置
    GPIO_InitStructure.GPIO_Mode = GPIO_Mode_OUT;//普通输出模式
    GPIO_InitStructure.GPIO_OType = GPIO_OType_PP;//推挽输出
    GPIO_InitStructure.GPIO_Speed = GPIO_Speed_100MHz;//100MHz
    GPIO_InitStructure.GPIO_PuPd = GPIO_PuPd_UP;//上拉
    GPIO_Init(VL53L0X_XshutPort_2, &GPIO_InitStructure);//初始化

//    GPIO_InitStructure.GPIO_Pin = VL53L0X_XshutPin_3;//端口配置
//    GPIO_InitStructure.GPIO_Mode = GPIO_Mode_OUT;//普通输出模式
//    GPIO_InitStructure.GPIO_OType = GPIO_OType_PP;//推挽输出
//    GPIO_InitStructure.GPIO_Speed = GPIO_Speed_100MHz;//100MHz
//    GPIO_InitStructure.GPIO_PuPd = GPIO_PuPd_UP;//上拉
//    GPIO_Init(VL53L0X_XshutPort_3, &GPIO_InitStructure);//初始化

   GPIO_InitStructure.GPIO_Pin = VL53L0X_XshutPin_4;//端口配置
   GPIO_InitStructure.GPIO_Mode = GPIO_Mode_OUT;//普通输出模式
   GPIO_InitStructure.GPIO_OType = GPIO_OType_PP;//推挽输出
   GPIO_InitStructure.GPIO_Speed = GPIO_Speed_100MHz;//100MHz
   GPIO_InitStructure.GPIO_PuPd = GPIO_PuPd_UP;//上拉
   GPIO_Init(VL53L0X_XshutPort_4, &GPIO_InitStructure);//初始化


    GPIO_SetBits(VL_IIC_PORT,VL53L0X_SCL_PIN);	//PB10,PB11 输出高
